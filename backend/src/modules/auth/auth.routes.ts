...
import { authPublicLimiter, authSensitiveLimiter } from '../../middlewares/rateLimiter.js';
import { asyncHandler } from '../../utils/asyncHandler.js';

export const authRouter = Router();

authRouter.post('/register', authPublicLimiter, asyncHandler(controller.register));
